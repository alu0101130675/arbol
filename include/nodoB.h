...
public:
  ...
  void set_dcho(NodoB *x=nullptr) { dcho = x; };
  void set_izq(NodoB *x=nullptr) { izq = x; };
  void write();
};

template <class Clave>
NodoB<Clave>::NodoB() : dato(NULL),
                        izq(nullptr),
                        dcho(nullptr)
{
}
...
template <class Clave>
NodoB<Clave>::NodoB(Clave dato, NodoB *izq, NodoB *dcho) : dato(dato),
                                                           izq(izq),
                                                           dcho(dcho)
{
}
